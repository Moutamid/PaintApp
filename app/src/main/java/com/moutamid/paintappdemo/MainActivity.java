package com.moutamid.paintappdemo;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    private DrawingSlateView mDrawingSlateView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDrawingSlateView = (DrawingSlateView)findViewById(R.id.drawing);
        ...
        mDrawingSlateView.setBrushSize(mediumBrush);
    ...
    public void paintClicked(View view){
        if (view != currPaint){
            ...
            mDrawingSlateView.setColor(colorTag);
            ...
            mDrawingSlateView.setErase(false);
            mDrawingSlateView.setBrushSize(mDrawingSlateView.getLastBrushSize());
        }
    }
    ...
    private void showBrushSizeChooserDialog(){
        ...
        smallBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mDrawingSlateView.setBrushSize(smallBrush);
                mDrawingSlateView.setLastBrushSize(smallBrush);
                brushDialog.dismiss();
            }
        });
        ...
        mediumBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                mDrawingSlateView.setBrushSize(mediumBrush);
                mDrawingSlateView.setLastBrushSize(mediumBrush);
                brushDialog.dismiss();
            }
        });
        ...
        largeBtn.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v) {
                mDrawingSlateView.setBrushSize(largeBrush);
                mDrawingSlateView.setLastBrushSize(largeBrush);
                brushDialog.dismiss();
            }
        });
        mDrawingSlateView.setErase(false);
    ...
    private void showEraserSizeChooserDialog(){
        ...
        smallBtn.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v) {
                mDrawingSlateView.setErase(true);
                mDrawingSlateView.setBrushSize(smallBrush);
                brushDialog.dismiss();
            }
        });
    ...
    private void showSavePaintingConfirmationDialog(){
        ...
        saveDialog.setPositiveButton("Yes", new DialogInterface.OnClickListener(){
            public void onClick(DialogInterface dialog, int which){
                //save drawing
                mDrawingSlateView.setDrawingCacheEnabled(true);
                String imgSaved = MediaStore.Images.Media.insertImage(
                        getContentResolver(), mDrawingSlateView.getDrawingCache(),
                ...
                mDrawingSlateView.destroyDrawingCache();
            }
        });
